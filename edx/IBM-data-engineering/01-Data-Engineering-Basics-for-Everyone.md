...
Big data has five V's: Velocity, how fast data is created; Volume, scale of data; Variety, diversity of data; Veracity, quality and origin of data; Value, need to turn raw data to value like medical insights, satisfaction, money.

### Module Three: Data Engineering Life Cycle
...
* Data storage and integration layer. This is where data is stored for processing, transferring, merging.
